...
class Window(tk.Tk):
    def __init__(self,**kwargs):
        ...
        Button(bottom_frame,text="按鈕1",font=('Helvetica', '24')).pack(side=tk.LEFT,fill=tk.BOTH,expand=True)
        Button(bottom_frame,text="按鈕2",font=('Helvetica', '24')).pack(side=tk.LEFT,fill=tk.BOTH,expand=True)
        ...
        Button(bottom_frame,text="按鈕6",font=('Helvetica', '24')).pack(side=tk.LEFT,fill=tk.BOTH,expand=True)
        bottom_frame.pack(expand=True,fill=tk.BOTH)
...
def main ():
    window =Window()
    window.title("this is a firest window")
